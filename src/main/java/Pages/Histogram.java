...
public class Histogram {
	...
	public Histogram(WebDriver driver) {
		this.driver = driver;
	}
	
	public void NavigateToHistogram() {
	...
	try {
		...
		SearchReport.click();
		SearchReport.sendKeys("Histo_Test_Priya");
	} catch (InterruptedException e) {
...
/////------------Add Histogram Chart-------/////////
	try {
        ...
        // Edit button
        WebElement button = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//img[contains(@src, 'data:image/svg+xml,%3Csvg')]")
        ));
//        button.click();
        System.out.println("Button is clickable.");
    ...
    WebElement chartElement = driver.findElement(By.xpath("//*[@id='19517']"));
...
////------------Title-------------/////
    ...
    try {
		...
		driver.findElement(By.xpath("//input[@id='titleText']")).sendKeys("Histogram Test");
