...
public class HomePage {
	...
	public void NavigateToDataCanvas() {
	...
	try {
		...
		SearchReport.click();
		SearchReport.sendKeys("Area_Chart_Test");
	} catch (InterruptedException e) {
...
//        button.click();
    ...
    WebElement chartElement = driver.findElement(By.xpath("//*[@id='19820']"));
 ...
 /////////--------Y Axis--------------///////////////     
	  ...
	  // Perform drag-and-drop- y axis
	     ...
	     Thread.sleep(5000);
	     driver.findElement(By.xpath("//div[@class='indicatorCover']/span[@class='aggregationIndicator' and text()='COUNT']")).click();
	     
	     Thread.sleep(2000);
	     driver.findElement(By.xpath("//div[@class='ant-select-selection-selected-value' and @title='COUNT']")).click();
	     
	     Thread.sleep(2000);
	     driver.findElement(By.xpath("//li[@class='ant-select-dropdown-menu-item' and text()='AVG']")).click();
	     
	     //Cancel button//////////
	     //try {
	 		//Thread.sleep(5000);
	 		//WebElement activeTab = driver.findElement(By.xpath("//button[@class='ant-btn ant-btn-default' and span[text()='Cancel']]"));
	 	    //activeTab.click();
	 	//} catch (InterruptedException e) {
	 		 //TODO Auto-generated catch block
	 		//e.printStackTrace();
	 ...
	 /////------Save------------/////////////   
	     try {
	   	Thread.sleep(5000);
	      driver.findElement(By.xpath("//button[@class='ant-btn ant-btn-primary' and span[text()='Save']]")).click();
	...
	///////////////----------------Filter---------////////////////
	  ...
	  // Perform drag-and-drop- filters axis
	   ...
	   //Select filter 
	     //Thread.sleep(5000);
	     //driver.findElement(By.xpath("//div[@class='indicatorCover']/span[@class='aggregationIndicator' and text()='STANDARD_FILTER']")).click();
	     	     
	///////////////-----------Group By-------------//////////////////
	     
	     Thread.sleep(5000);
		  // Locate the source element (element to be dragged)- filters axis
		     WebElement draggableElement3 = driver.findElement(By.xpath("//li[@class='ant-menu-item' and contains(., 'subject')]"));
		     
		  // Locate the target element (element to drop onto)
		     WebElement droppableElement3 = driver.findElement(By.id("groupBy"));
		     
		  // Perform drag-and-drop- filters axis
		     actions.dragAndDrop(draggableElement3, droppableElement3).perform();	
		     System.out.println("aa");
	...
	////-------------Legend Order--------------////////////////////
		   ...
		   Thread.sleep(5000);
		   // Locate the source element (element to be dragged)- filters axis
		   WebElement draggableElement4 = driver.findElement(By.xpath("//li[@class='ant-menu-item' and contains(., 'points')]"));
			     
		   // Locate the target element (element to drop onto)
		   WebElement droppableElement4 = driver.findElement(By.id("legendOrder"));
			     
		   // Perform drag-and-drop- filters axis
		   actions.dragAndDrop(draggableElement4, droppableElement4).perform();	
		   System.out.println("aa");
		   
		 //Select ASC/DESC Order// 
		   Thread.sleep(5000);
		   driver.findElement(By.xpath("//div[@class='indicatorCover']/span[@class='aggregationIndicator' and text()='ASC']")).click();
		   
		   Thread.sleep(2000);
		   driver.findElement(By.xpath("//div[@class='ant-select-selection-selected-value' and @title='Ascending']")).click();
		   
		   Thread.sleep(3000);
		   driver.findElement(By.xpath("//li[@class='ant-select-dropdown-menu-item' and text()='Descending']")).click();
	...
	///////--------------Tooltip---------////////////////////////
		   ...
		   Thread.sleep(5000);
		   // Locate the source element (element to be dragged)- filters axis
		   WebElement draggableElement5 = driver.findElement(By.xpath("//li[@class='ant-menu-item' and contains(., 'student name')]"));
			     
		   // Locate the target element (element to drop onto)
		   WebElement droppableElement5 = driver.findElement(By.id("tooltip"));
			     
		   // Perform drag-and-drop- filters axis
		   actions.dragAndDrop(draggableElement5, droppableElement5).perform();	
		   System.out.println("aa");
...
//}
    ...
    try {
		...
		driver.findElement(By.xpath("//input[@id='titleText']")).sendKeys("Area Chart2");
...
////////------Operator-------///////
		...
		WebElement operation = driver.findElement(By.xpath("//div[@class='conditional-operator ant-select ant-select-enabled']/div"));
		String ariaExpanded = operation.getAttribute("aria-expanded");
  ...
  //try {
		...
		//driver.findElement(By.xpath("//button[@class='ant-btn colorButton' and normalize-space(span)='#CCCCCC']")).click();
  		...
  		//Thread.sleep(10000);
		//driver.findElement(By.xpath("//div[@title='#BD10E0'][@tabindex='0'][@style='background: rgb(189, 16, 224); height: 100%; width: 100%; cursor: pointer; position: relative; outline: none; border-radius: 3px; box-shadow: rgba(0, 0, 0, 0.15) 0px 0px 0px 1px inset;']")).click();
